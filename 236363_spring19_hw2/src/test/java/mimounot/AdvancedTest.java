...
public class AdvancedTest extends AbstractTest {
    ...
    public void initDatabase() {
        ...
        MimounaList ml00 = new MimounaList();
        ml3.setId(100);
        ml3.setCity("NY");
...
//        assertEquals(Arrays.asList(1, 2, 3, 4), res_arr);
        ...
        res = Solution.followMimounalist(1, 100);
        assertEquals(OK, res);

        res = Solution.followMimounalist(2, 100);
        assertEquals(OK, res);

        res = Solution.followMimounalist(3, 100);
        assertEquals(OK, res);

                /*
        user 1 follows 1 and 2 and 3 and 100
        user 2 follows 1 and 2 and 100
        user 3 follows 1 and 3 and 100 -> each follow exactly 67% of user1's follows
         */
        res_arr = Solution.getCloseUsers(1);
        assertEquals(Arrays.asList(2, 3), res_arr);
        ...
        /*
        user 1 follows 2 and 3 and 100
        user 3 follows 3 and 100
         */
        res_arr = Solution.getCloseUsers(1);
        assertEquals(new ArrayList<Integer>(), res_arr);
...
//        assertEquals(Arrays.asList(1, 2, 3), res_arr);
        ...
        res_arr = Solution.getCloseUsers(1);
        assertEquals(Collections.singletonList(4), res_arr);
...
//        }
        ...
        for (int i = 1000; i < 1003; ++i) {
            res = Solution.followMimounalist(4, i);
            assertEquals(OK, res);
        }
        ...
        res_arr = Solution.getMimounaListRecommendation(2);
        assertEquals(Arrays.asList(1009, 1003, 1004), res_arr);
    }
